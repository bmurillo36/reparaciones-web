/* ==========================================================================
   ...
   CÓMO SE USA
     node herramientas/avisar-indexnow.js                 lo que cambió hoy
     node herramientas/avisar-indexnow.js --todo          la web entera
     node herramientas/avisar-indexnow.js <url> <url>…    esas direcciones y nada más
     node herramientas/avisar-indexnow.js --esperar       espera a que estén en línea
     node herramientas/avisar-indexnow.js --probar        no manda nada, solo lo cuenta
...
const CLAVE = "a5686ddad7d74aa78caf4833aede3767";
const HOST  = "www.reparaciones.net";
  ...
  if(sueltas.length){
    ...
    if(TODO){
      ...
      if(!urls.length){
        ...
        console.log("publicar, comprueba que regeneraste la web antes.");
